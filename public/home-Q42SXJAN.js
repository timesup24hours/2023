import{f as a}from"./chunk-YTPAW67S.js";var r="#contact-link-containers a.contact-link:hover svg path { fill: var(--color-primary); display: flex; justify-content: space-between; height: 100%; flex: 1; } #expert { font-weight: 500; }";var c=`<div id="main-content" class="flex flex-row flex-grow-1 gap">
...
</div>`;var i=class extends HTMLElement{constructor(){super();a(this,"render",()=>{})}connectedCallback(){this.classList.add("hydrated");let n=document.createElement("style");n.innerHTML=r,this.innerHTML=c,this.appendChild(n),this.render();let l=document.querySelector("#banner-center #title");l&&(l.innerHTML="Huanlin Huang");function e(d,h){let u=new Date(d);return new Date(h).getFullYear()-u.getFullYear()}let t=new Date().toISOString(),o=[{type:"React",value:e(new Date(2017,1,1),t),enabled:!0},{type:"Redux",value:e(new Date(2017,1,1),t),enabled:!0},{type:"JS",value:e(new Date(2017,1,1),t),enabled:!0},{type:"HTML",value:e(new Date(2017,1,1),t),enabled:!0},{type:"A11y",value:e(new Date(2020,1,1),t),enabled:!0},{type:"CSS",value:e(new Date(2017,1,1),t),enabled:!0},{type:"NodeJS",value:e(new Date(2020,1,1),t),enabled:!0}],s=this.querySelector("huanlin-donut");s&&s.setAttribute("data",JSON.stringify(o))}};a(i,"localName","huanlin-home");export{i as default};
