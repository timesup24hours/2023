import{f as r}from"./chunk-YTPAW67S.js";var e=class extends HTMLElement{constructor(){super();r(this,"handleBlur",t=>{this.removeAttribute("tabindex")});let t=this.attachShadow({mode:"open"});t.innerHTML=`
      <style>
        #option {
