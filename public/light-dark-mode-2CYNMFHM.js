import{a as t}from"./chunk-YQYQPID3.js";import{c as o}from"./chunk-SS6F5745.js";var i=class extends HTMLElement{constructor(){super();o(this,"handleModeChange",e=>{this.getAttribute("mode")==="light"?(this.setAttribute("mode","dark"),t.setColorScheme("dark")):(this.setAttribute("mode","light"),t.setColorScheme("light"))});let e=this.attachShadow({mode:"open"});e.innerHTML=`
      <style>
        * { 
          margin: 0;
          padding: 0;
...
//# sourceMappingURL=light-dark-mode-2CYNMFHM.js.map
